    ...
    protected function updateUserPermissions($user, stdClass $apiUser)
    {
        ...
        Log::info(json_encode([
            ...
            'data' => [
                ...
                'local_user_id' => $user->id,
                'api_user_uuid' => $apiUser->uuid,
                'local_permissions_after_sync' => $user->getAllPermissions()->pluck('name')->toArray(),
            ],
        ]));
